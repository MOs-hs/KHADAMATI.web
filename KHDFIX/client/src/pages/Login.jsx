      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-80px)]">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-100 dark:border-gray-700 relative overflow-hidden transition-all duration-300 hover:shadow-glow">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8 relative z-10 animate-fade-in-up animation-delay-500">
              <button
                type="button"
                onClick={() => setSelectedRole('customer')}
                className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all duration-300 ${selectedRole === 'customer'
              ...
              >
                ...
                <span className="font-bold text-sm">{t('auth.customer')}</span>
              </button>

              <button
                type="button"
                onClick={() => setSelectedRole('provider')}
                className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all duration-300 ${selectedRole === 'provider'
              ...
              >
                ...
                <span className="font-bold text-sm">{t('auth.provider')}</span>
              </button>
            </div>
