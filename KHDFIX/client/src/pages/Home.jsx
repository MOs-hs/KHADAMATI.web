...
import { getServices, getProviders, getUsers, getCategories, initializeMockData } from '../utils/mockData';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 transition-colors duration-300">
      ...
      {/* Hero Section - Cleaned up (No Logo) */}
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => {
              ...
              const providerUser = provider ? users.find(u => u.user_id === provider.user_id) : null;
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {providers.map((provider) => (
              <ProviderCard
                ...
                provider={provider}
                user={getProviderUser(provider.provider_id)}
              />
            ))}
          </div>
        </div>
